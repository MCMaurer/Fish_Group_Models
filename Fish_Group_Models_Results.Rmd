...
```{r, cache=F}
my_icc_plot(lat_typ_int, total_re.form = ~(1|group_ID) + (1|tank), lesser_re.form = ~(1|tank))
my_icc_tibble(model = lat_typ_int, total_re.form = ~(1|group_ID) + (1|tank), lesser_re.form = ~(1|tank)) %>% knitr::kable()
```
